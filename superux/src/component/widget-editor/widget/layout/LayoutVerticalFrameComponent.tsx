 ...
 */
const LayoutVerticalFrameComponent: React.FC<IProps> = ({ id, properties, widgetStyle, children, event }: IProps) => {
    return (
        <div
            id={id}
...
export default observer(LayoutVerticalFrameComponent);
